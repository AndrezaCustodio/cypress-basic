...
//Digitando campos e clicando em elementos
describe('Central de Atendimento ao Cliente TAT', function() {
    ...
    it('campo telefone continua vazio quando preenchido com valor nao numerico', function(){
        cy.get('#phone')
        .type('abcdefghijklmnopqrstuvwxyz').should('have.value', '')
    })
    ...
    it('preenche e limpa os campos nome, sobrenome, email e telefone', function(){
        ...
        cy.get('#email')
            .type('andreza.silva@uol.com')
            .should('have.value', 'andreza.silva@uol.com')
            .clear()
            .should('have.value', '')
        cy.get('#phone')
            .type('999999999')
  ...
  //Selecionando campos em seleção suspensa usando o .select
  ...
  //Marcando inputs do tipo radio usando o .check
  ...
  it('exibe mensagem de erro quando o telefone se torna obrigatório mas não é preenchido antes do envio do formulário', function(){
    ...
    cy.get('.error').should('not.be.checked')
  })
  ...
  //arrasta o arquivo do computador para o local
  ...
  it('seleciona um arquivo utilizando uma fixture para a qual foi dada a alias', function(){
